import express, { type Request, type Response, type RequestHandler, Router, type NextFunction } from 'express'
// @ts-ignore 
...
export function asyncWrapper(fn: AsyncRequestHandler): RequestHandler {
  return (req, res, next) => fn(req, res, next).catch(next) as Promise<void>
}
